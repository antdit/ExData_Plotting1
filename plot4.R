...
with(subdata, {
    ...
    ## line chart topleft
    plot(subdata$final, subdata$Global_active_power, type="n", xlab="", ylab="Global Active Power")
    lines(subdata$final, subdata$Global_active_power, type="l")
    
    ## line chart topright
    plot(subdata$final, subdata$Voltage, type="n", xlab="datetime", ylab="Voltage")
    lines(subdata$final, subdata$Voltage, type="l")
    
    ## multiple line chart bottomleft        
